...
values
    ...
    ("zh_Hans_CN",  "LOC_DA_DISTRICT_ENCAMPMENT_DESCRIPTION",                   "您城市里的军事机构驻地。拥有区域防御，可作为陆地军事单位的征召地点，城市消耗 [ICON_CITIZEN] 人口加速单位的训练时不再消耗凝聚力。获得等于驻扎单位等级的 [ICON_PRODUCTION] 生产力相邻加成。"),
    ("zh_Hans_CN",  "LOC_ENCAMPMENT_CITIZEN_RUSH_UNITS_DESCRIPTION",            "花费{1_unity}凝聚力，城市将失去{2_pop} [ICON_Citizen] 人口，并为当前单位的训练投入{3_Amount} [ICON_PRODUCTION] 生产力。"), 
    ("zh_Hans_CN",  "LOC_ENCAMPMENT_CITIZEN_RUSH_UNITS_TITLE",                  "强制征召"), 
    ("zh_Hans_CN",  "LOC_ENCAMPMENT_CITIZEN_RUSH_UNITS_TOOLTIP",                "消耗 [ICON_CITIZEN] 人口和凝聚力加速单位的训练"), 
