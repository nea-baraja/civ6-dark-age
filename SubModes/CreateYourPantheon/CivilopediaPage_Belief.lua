...
local sectionId = page.SectionId;
	...
	-- Gather info.
    local belief = GameInfo.Beliefs[pageId] or GameInfo.Pantheons[pageId];
    if(belief == nil) then
        return;
    end           
	...
	if(GameInfo.Pantheons[pageId]) then
		beliefClass =  GameInfo.BeliefClasses['BELIEF_CLASS_PANTHEON'];
	end
