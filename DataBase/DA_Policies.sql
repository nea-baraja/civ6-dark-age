...
values
	('POLICY_URBAN_PLANNING',			'URBAN_PLANNING_BUILDING_PRODUCTION'),   --城市规划 改为造建筑+2生产力
	('POLICY_URBAN_PLANNING',			'URBAN_PLANNING_DISTRICT_PRODUCTION'),   --城市规划 还有造区域+2生产力
	('POLICY_URBAN_PLANNING',			'URBAN_PLANNING_AQUEDUCT_PRODUCTION'),   --城市规划 还有水渠+2生产力
...
--都不加了
	...
	('POLICY_GOD_KING',					'GOD_KING_OBSERVATORY_FAITH'),   --君主崇拜 观星台加信仰
...
values
	('URBAN_PLANNING_BUILDING_PRODUCTION',			'MODIFIER_PLAYER_CITIES_ADJUST_BUILDING_PRODUCTION_CHANGE',	NULL),
	('URBAN_PLANNING_DISTRICT_PRODUCTION',			'MODIFIER_PLAYER_CITIES_ADJUST_DISTRICT_PRODUCTION_CHANGE',	NULL),
	('URBAN_PLANNING_AQUEDUCT_PRODUCTION',			'MODIFIER_PLAYER_DISTRICTS_ADJUST_YIELD_CHANGE',		'RS_PLOT_HAS_DISTRICT_AQUEDUCT'),
	('GOD_KING_OBSERVATORY_FAITH',					'MODIFIER_PLAYER_CITIES_ADJUST_BUILDING_YIELD_CHANGE',	NULL),
...
values
	('URBAN_PLANNING_BUILDING_PRODUCTION',					'Amount',				2),		
	('URBAN_PLANNING_DISTRICT_PRODUCTION',					'Amount',				2),		
	('URBAN_PLANNING_AQUEDUCT_PRODUCTION',					'YieldType',			'YIELD_PRODUCTION'),		
	('URBAN_PLANNING_AQUEDUCT_PRODUCTION',					'Amount',				2),		
	...
	('GOD_KING_OBSERVATORY_FAITH',							'YieldType',			'YIELD_FAITH'),
	('GOD_KING_OBSERVATORY_FAITH',							'Amount',				4),		
	('GOD_KING_OBSERVATORY_FAITH',							'BuildingType',			'BUILDING_OBSERVATORY'),			
...
values
	...
	('POLICY_LAND_MEASURE',				'LAND_MEASURE_AQUEDUCT_FOOD'),
...
values
	...
	('LAND_MEASURE_AQUEDUCT_FOOD',					'MODIFIER_PLAYER_DISTRICTS_ADJUST_YIELD_CHANGE',			'RS_PLOT_HAS_DISTRICT_AQUEDUCT'),
...
values
	...
	('LAND_MEASURE_AQUEDUCT_FOOD',							'Amount',					2),
	('LAND_MEASURE_AQUEDUCT_FOOD',							'YieldType',				'YIELD_FOOD'),
