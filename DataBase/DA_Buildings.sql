...
values
    ...
    ('BUILDING_OBSERVATORY',            'LOC_BUILDING_OBSERVATORY_NAME',            60,     1,              'LOC_BUILDING_OBSERVATORY_DESCRIPTION',                
...
values
  --   ('MONUMENT_CAN_BUILD_TEST',                     'MODIFIER_PLAYER_ADJUST_DISTRICT_UNLOCK',                     NULL),
    ...
    -- ('MONUMENT_LOYALTY_WITH_CAMPUS',                'MODIFIER_SINGLE_CITY_ADJUST_IDENTITY_PER_TURN',                'RS_CITY_HAS_DISTRICT_CAMPUS'),
    -- ('MONUMENT_LOYALTY_WITH_THEATER',               'MODIFIER_SINGLE_CITY_ADJUST_IDENTITY_PER_TURN',                'RS_CITY_HAS_DISTRICT_THEATER'),
    -- ('MONUMENT_LOYALTY_WITH_HOLY_SITE',             'MODIFIER_SINGLE_CITY_ADJUST_IDENTITY_PER_TURN',                'RS_CITY_HAS_DISTRICT_HOLY_SITE'),
    ...
    ('WATER_MILL_SP_DISTRICTS_PRODUCTION',          'MODIFIER_CITY_DISTRICTS_ADJUST_YIELD_CHANGE',                  'RS_IS_SPECIALITY_DISTRICT'),
...
values
    ...
    ('GRANARY_PLANTATION_FOOD',                     'MODIFIER_CITY_PLOT_YIELDS_ADJUST_PLOT_YIELD',                  'RS_PLOT_HAS_IMPROVEMENT_PLANTATION',       'RS_PLAYER_HAS_TECH_IRRIGATION'),
...
values
    ...
    ('OBSERVATORY_SCIENCE_WITH_NATURAL_WONDER',     'Amount',                   1),
    ...
    ('OBSERVATORY_SCIENCE_ADJACENT_TO_WATER',       'Amount',                   1),
    ...
    ('OBSERVATORY_SCIENCE_ADJACENT_TO_MOUNTAIN',    'Amount',                   1),
    ...
    ('GOV_WIDE_CITY_UNITY',                         'Key',                      'PROP_UNITY_RATE_FROM_OTHERS'),
    ('GOV_WIDE_CITY_UNITY',                         'Amount',                   1),
    ('GOV_WIDE_CITY_UNITY_GOVERNOR',                'Key',                      'PROP_UNITY_RATE_FROM_OTHERS'),
    ('GOV_WIDE_CITY_UNITY_GOVERNOR',                'Amount',                   1),
    ('GOV_CONQUEST_CITY_UNITY',                     'Key',                      'PROP_UNITY_RATE_FROM_OTHERS'),
    ...
    ('WATER_MILL_SP_DISTRICTS_PRODUCTION',          'YieldType',                'YIELD_FOOD'),
...
insert or replace into ModifierArguments(ModifierId, Name, Value) select
    'GOV_TALL_UNITY_'||numbers, 'Key', 'PROP_UNITY_RATE_FROM_OTHERS'
    from counter where numbers > 0 and numbers < 9;
